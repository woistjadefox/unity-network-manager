...
public class UnityNetworkRigidbody : MonoBehaviour {
    ...
    void Start() {
        ...
        if (rigidbody != null && !rigidbody.isKinematic) {
            this._isRigidbody = true;
        } else {
            Debug.Log("UnityNetworkRigidbody:non-rigidbody");
        }
    }
    ...
    void OnSerializeNetworkView(BitStream stream, NetworkMessageInfo info) {
        ...
        if (stream.isWriting) {
            ...
            // lerp local player to correct server pos
            if (Network.player == playerEngine.GetOwner()) {

                this.playerEngine.serverPos = pos;
                this.playerEngine.serverRot = rot;
                this.playerEngine.LerpToTarget();
            } 
    ...
    void Update() {
        ...
        // This is only for remote peers, get off
        if ((Network.player == playerEngine.GetOwner()) || Network.isServer) {
            return; 
        }
